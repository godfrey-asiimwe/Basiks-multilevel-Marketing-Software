<?php  include 'header.php' ?>
           ...
           <ul class="sidebar-menu">
              ...
              <li  class="active"><a class="nav-link" href="stockist.php"><i class="fas fa-shopping-bag"></i> <span>Stockist</span></a></li>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                  <div class="card">
                    ...
                    <?php 
                       if(isset($_GET['deleteStockist'])){
                          include_once 'deleteStockist.php';
                       }elseif(isset($_GET['editStockist'])){
                          include_once 'editStockist.php';
                       }elseif(isset($_GET['disableStockist'])){
                          include_once 'disableStockist.php';
                       }else{
                         ?>
                      <h4>Products</h4>
                                  ...
                                  <div class="col-lg-7">
                                    <div class="p-5">
                                      <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Create a Stockist</h1>
                                      </div>
                                      <form action="include/saveStockist.php" method="post" enctype='multipart/form-data' class="user">
                                        <div class="form-group row">
                                          <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" name="name" class="form-control form-control-user" id="exampleFirstName" placeholder="Stockist Name">
                                          </div>
                                          <div class="col-sm-6">
                                            <input type="text" name="address" class="form-control form-control-user" id="exampleLastName" placeholder="Physical Address">
                                          </div>
                                        </div>

                                        <div class="form-group row">
                                          <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" name="amount" class="form-control form-control-user" id="exampleFirstName" placeholder="Product Price">
                                          </div>
                                           <div class="col-sm-6">
                                            <input type="text" name="phone" class="form-control form-control-user" id="exampleLastName" placeholder="Mobile Phone">
                                          </div>
                                        </div>
